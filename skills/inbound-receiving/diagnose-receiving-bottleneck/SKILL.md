---
name: diagnose-receiving-bottleneck
description: Diagnose receiving bottlenecks from inbound volume, dock capacity, labor, equipment, documents, queues, and exceptions.
license: MIT
---
...
Use this skill to diagnose receiving bottlenecks from inbound volume, dock capacity, labor, equipment, documents, queues, and exceptions. The expected
output is a structured bottleneck diagnosis.
...
- produce a bottleneck diagnosis;
- support diagnose receiving bottleneck in a warehouse operation;
