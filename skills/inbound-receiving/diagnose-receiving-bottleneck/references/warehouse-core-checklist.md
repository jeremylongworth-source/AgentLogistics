# Diagnose Receiving Bottleneck Warehouse Core Checklist
...
This reference keeps `diagnose-receiving-bottleneck` aligned with the AL-06 warehouse-operator flow.
...
- Include the requested bottleneck diagnosis.
