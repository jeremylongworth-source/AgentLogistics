---
name: inspect-received-goods
description: Inspect received goods for visible condition, identity, packaging, labeling, and hold-or-release evidence.
license: MIT
---
...
Use this skill to inspect received goods for visible condition, identity, packaging, labeling, and hold-or-release evidence. The expected
output is a structured inspection result.
...
- produce a inspection result;
- support inspect received goods in a warehouse operation;
