# Inspect Received Goods Warehouse Core Checklist
...
This reference keeps `inspect-received-goods` aligned with the AL-06 warehouse-operator flow.
...
- Include the requested inspection result.
