---
name: plan-inbound-receiving
description: Plan inbound receiving work from appointment, load, dock, labor, document, and exception inputs.
license: MIT
---
...
Use this skill to plan inbound receiving work from appointment, load, dock, labor, document, and exception inputs. The expected
output is a structured receiving plan.
...
- produce a receiving plan;
- support plan inbound receiving in a warehouse operation;
