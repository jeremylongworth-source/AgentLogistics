# Plan Inbound Receiving Warehouse Core Checklist
...
This reference keeps `plan-inbound-receiving` aligned with the AL-06 warehouse-operator flow.
...
- Include the requested receiving plan.
