# Plan Putaway Warehouse Core Checklist
...
This reference keeps `plan-putaway` aligned with the AL-06 warehouse-operator flow.
...
- Include the requested putaway plan.
