---
name: process-receiving-discrepancy
description: Process receiving discrepancies by classifying variance type, evidence, impact, ownership, and next actions.
license: MIT
---
...
Use this skill to process receiving discrepancies by classifying variance type, evidence, impact, ownership, and next actions. The expected
output is a structured discrepancy record.
...
- produce a discrepancy record;
- support process receiving discrepancy in a warehouse operation;
...
Calculate variance and percent variance only when expected and actual units match.
