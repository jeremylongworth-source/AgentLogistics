# Process Receiving Discrepancy Warehouse Core Checklist
...
This reference keeps `process-receiving-discrepancy` aligned with the AL-06 warehouse-operator flow.
...
- Include the requested discrepancy record.
