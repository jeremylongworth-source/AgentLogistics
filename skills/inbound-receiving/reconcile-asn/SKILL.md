---
name: reconcile-asn
description: Reconcile advance ship notice data against purchase orders, shipment documents, received counts, and exceptions.
license: MIT
---
...
Use this skill to reconcile advance ship notice data against purchase orders, shipment documents, received counts, and exceptions. The expected
output is a structured ASN reconciliation.
...
- produce a ASN reconciliation;
- support reconcile asn in a warehouse operation;
...
Calculate variance as received quantity minus expected quantity only when item identifiers and units match.
