# Reconcile ASN Warehouse Core Checklist
...
This reference keeps `reconcile-asn` aligned with the AL-06 warehouse-operator flow.
...
- Include the requested ASN reconciliation.
