---
name: analyze-order-profile
description: Analyze order volume, lines, units, channels, cutoffs, mix, and variability for warehouse planning.
license: MIT
---
...
Use this skill to analyze order volume, lines, units, channels, cutoffs, mix, and variability for warehouse planning. The expected
output is a structured order-profile summary.
...
- produce a order-profile summary;
- support analyze order profile in a warehouse operation;
...
Use basic calculations such as lines per order, units per order, orders per day, and percent mix only when definitions and periods are clear.
