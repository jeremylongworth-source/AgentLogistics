# Analyze Order Profile Warehouse Core Checklist
...
This reference keeps `analyze-order-profile` aligned with the AL-06 warehouse-operator flow.
...
- Include the requested order-profile summary.
