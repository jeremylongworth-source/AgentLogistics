---
name: analyze-product-flow
description: Analyze how products or load units move through receiving, storage, replenishment, picking, packing, and shipping.
license: MIT
---
...
Use this skill to analyze how products or load units move through receiving, storage, replenishment, picking, packing, and shipping. The expected
output is a structured product-flow assessment.
...
- produce a product-flow assessment;
- support analyze product flow in a warehouse operation;
