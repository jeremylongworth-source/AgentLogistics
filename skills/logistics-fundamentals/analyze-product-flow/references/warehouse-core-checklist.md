# Analyze Product Flow Warehouse Core Checklist
...
This reference keeps `analyze-product-flow` aligned with the AL-06 warehouse-operator flow.
...
- Include the requested product-flow assessment.
