---
name: map-logistics-flow
description: Map logistics process steps, nodes, roles, documents, system transactions, handoffs, and exceptions.
license: MIT
---
...
Use this skill to map logistics process steps, nodes, roles, documents, system transactions, handoffs, and exceptions. The expected
output is a structured flow map.
...
- produce a flow map;
- support map logistics flow in a warehouse operation;
