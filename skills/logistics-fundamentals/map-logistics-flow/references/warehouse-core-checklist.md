# Map Logistics Flow Warehouse Core Checklist
...
This reference keeps `map-logistics-flow` aligned with the AL-06 warehouse-operator flow.
...
- Include the requested flow map.
