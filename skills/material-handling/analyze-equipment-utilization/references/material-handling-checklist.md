# Analyze Equipment Utilization Material Handling Checklist
...
This reference keeps `analyze-equipment-utilization` aligned with the AL-10 material-handling foundation and the `material-handling-analyst` skillset.
