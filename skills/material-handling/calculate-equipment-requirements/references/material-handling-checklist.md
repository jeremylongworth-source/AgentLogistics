# Calculate Equipment Requirements Material Handling Checklist
...
This reference keeps `calculate-equipment-requirements` aligned with the AL-10 material-handling foundation and the `material-handling-analyst` skillset.
