# Classify Material Handling Requirements Material Handling Checklist
...
This reference keeps `classify-material-handling-requirements` aligned with the AL-10 material-handling foundation and the `material-handling-analyst` skillset.
