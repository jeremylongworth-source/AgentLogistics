# Evaluate AGV AMR Application Material Handling Checklist
...
This reference keeps `evaluate-agv-amr-application` aligned with the AL-10 material-handling foundation and the `material-handling-analyst` skillset.
