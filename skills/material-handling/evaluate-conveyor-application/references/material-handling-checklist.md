# Evaluate Conveyor Application Material Handling Checklist
...
This reference keeps `evaluate-conveyor-application` aligned with the AL-10 material-handling foundation and the `material-handling-analyst` skillset.
