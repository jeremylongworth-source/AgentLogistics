# Plan Material Flow Material Handling Checklist
...
This reference keeps `plan-material-flow` aligned with the AL-10 material-handling foundation and the `material-handling-analyst` skillset.
