# Select Material Handling Equipment Material Handling Checklist
...
This reference keeps `select-material-handling-equipment` aligned with the AL-10 material-handling foundation and the `material-handling-analyst` skillset.
