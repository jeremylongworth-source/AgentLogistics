---
name: plan-packing-operation
description: Plan packing work from order profile, product attributes, packaging, verification, stations, labor, and cutoffs.
license: MIT
---
...
Use this skill to plan packing work from order profile, product attributes, packaging, verification, stations, labor, and cutoffs. The expected
output is a structured packing plan.
...
- support plan packing operation in a warehouse operation;
