# Plan Packing Operation Warehouse Core Checklist
...
This reference keeps `plan-packing-operation` aligned with the AL-06 warehouse-operator flow.
...
- Include the requested packing plan.
