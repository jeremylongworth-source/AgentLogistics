---
name: plan-shipping-stage
description: Plan shipping staging from packed orders, carriers, routes, dock capacity, cutoffs, load sequence, and exceptions.
license: MIT
---
...
Use this skill to plan shipping staging from packed orders, carriers, routes, dock capacity, cutoffs, load sequence, and exceptions. The expected
output is a structured shipping staging plan.
...
- produce a shipping staging plan;
- support plan shipping stage in a warehouse operation;
