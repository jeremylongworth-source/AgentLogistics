# Verify Outbound Shipment Warehouse Core Checklist
...
This reference keeps `verify-outbound-shipment` aligned with the AL-06 warehouse-operator flow.
...
- Include the requested outbound verification result.
