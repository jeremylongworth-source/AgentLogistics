# Calculate Pick Productivity Warehouse Core Checklist
...
This reference keeps `calculate-pick-productivity` aligned with the AL-06 warehouse-operator flow.
...
- Include the requested pick productivity calculation.
