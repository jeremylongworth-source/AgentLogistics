# Plan Replenishment Warehouse Core Checklist
...
This reference keeps `plan-replenishment` aligned with the AL-06 warehouse-operator flow.
...
- Include the requested replenishment plan.
