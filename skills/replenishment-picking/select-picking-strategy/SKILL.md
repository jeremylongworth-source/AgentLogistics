---
name: select-picking-strategy
description: Select a picking strategy from order profile, SKU velocity, layout, zones, labor, equipment, and service constraints.
license: MIT
---
...
Use this skill to select a picking strategy from order profile, SKU velocity, layout, zones, labor, equipment, and service constraints. The expected
output is a structured picking strategy recommendation.
...
- produce a picking strategy recommendation;
- support select picking strategy in a warehouse operation;
