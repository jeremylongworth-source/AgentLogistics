---
name: analyze-storage-utilization
description: Analyze storage utilization from capacity, occupied inventory, unavailable locations, unit basis, and operating constraints.
license: MIT
---
...
Use this skill to analyze storage utilization from capacity, occupied inventory, unavailable locations, unit basis, and operating constraints. The expected
output is a structured storage utilization analysis.
...
- produce a storage utilization analysis;
- support analyze storage utilization in a warehouse operation;
...
Utilization equals occupied capacity divided by usable capacity. Show numerator, denominator, exclusions, and percentage when capacity data is supplied.
