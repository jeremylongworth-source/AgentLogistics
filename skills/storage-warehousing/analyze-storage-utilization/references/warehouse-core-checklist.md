# Analyze Storage Utilization Warehouse Core Checklist
...
This reference keeps `analyze-storage-utilization` aligned with the AL-06 warehouse-operator flow.
...
- Include the requested storage utilization analysis.
