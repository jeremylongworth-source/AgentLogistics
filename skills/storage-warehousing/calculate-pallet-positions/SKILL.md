---
name: calculate-pallet-positions
description: Calculate pallet positions from rack, floor, pallet, clearance, bay, level, and stacking assumptions.
license: MIT
---
...
Use this skill to calculate pallet positions from rack, floor, pallet, clearance, bay, level, and stacking assumptions. The expected
output is a structured pallet position calculation.
...
- produce a pallet position calculation;
- support calculate pallet positions in a warehouse operation;
...
Calculation is required. Show the selected formula, such as bays times pallets per bay times levels, or usable floor area divided by pallet footprint with access deductions.
