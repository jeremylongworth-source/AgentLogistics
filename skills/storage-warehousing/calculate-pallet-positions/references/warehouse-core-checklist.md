# Calculate Pallet Positions Warehouse Core Checklist
...
This reference keeps `calculate-pallet-positions` aligned with the AL-06 warehouse-operator flow.
...
- Include the requested pallet position calculation.
