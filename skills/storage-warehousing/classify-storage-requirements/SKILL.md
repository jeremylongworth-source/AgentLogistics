---
name: classify-storage-requirements
description: Classify storage requirements from SKU attributes, load units, velocity, handling, environment, and control needs.
license: MIT
---
...
Use this skill to classify storage requirements from SKU attributes, load units, velocity, handling, environment, and control needs. The expected
output is a structured storage requirement class.
...
- produce a storage requirement class;
- support classify storage requirements in a warehouse operation;
