# Classify Storage Requirements Warehouse Core Checklist
...
This reference keeps `classify-storage-requirements` aligned with the AL-06 warehouse-operator flow.
...
- Include the requested storage requirement class.
