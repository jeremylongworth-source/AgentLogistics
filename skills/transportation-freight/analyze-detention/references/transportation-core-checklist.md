# Analyze Detention Transportation Core Checklist
...
This reference keeps `analyze-detention` aligned with the AL-11 transportation and freight core and the `transportation-coordinator` skillset.
