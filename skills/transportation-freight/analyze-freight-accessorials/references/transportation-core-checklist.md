# Analyze Freight Accessorials Transportation Core Checklist
...
This reference keeps `analyze-freight-accessorials` aligned with the AL-11 transportation and freight core and the `transportation-coordinator` skillset.
