# Audit Freight Charge Transportation Core Checklist
...
This reference keeps `audit-freight-charge` aligned with the AL-11 transportation and freight core and the `transportation-coordinator` skillset.
