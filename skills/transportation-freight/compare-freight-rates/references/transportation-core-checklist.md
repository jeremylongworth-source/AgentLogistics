# Compare Freight Rates Transportation Core Checklist
...
This reference keeps `compare-freight-rates` aligned with the AL-11 transportation and freight core and the `transportation-coordinator` skillset.
