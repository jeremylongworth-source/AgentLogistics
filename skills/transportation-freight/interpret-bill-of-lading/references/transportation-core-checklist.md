# Interpret Bill Of Lading Transportation Core Checklist
...
This reference keeps `interpret-bill-of-lading` aligned with the AL-11 transportation and freight core and the `transportation-coordinator` skillset.
