# Manage Freight Claim Transportation Core Checklist
...
This reference keeps `manage-freight-claim` aligned with the AL-11 transportation and freight core and the `transportation-coordinator` skillset.
