# Plan Freight Consolidation Transportation Core Checklist
...
This reference keeps `plan-freight-consolidation` aligned with the AL-11 transportation and freight core and the `transportation-coordinator` skillset.
