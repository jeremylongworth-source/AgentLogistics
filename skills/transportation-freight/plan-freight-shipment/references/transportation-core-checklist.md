# Plan Freight Shipment Transportation Core Checklist
...
This reference keeps `plan-freight-shipment` aligned with the AL-11 transportation and freight core and the `transportation-coordinator` skillset.
