# Select Carrier Transportation Core Checklist
...
This reference keeps `select-carrier` aligned with the AL-11 transportation and freight core and the `transportation-coordinator` skillset.
