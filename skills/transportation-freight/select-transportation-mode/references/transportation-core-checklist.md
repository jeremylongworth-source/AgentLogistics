# Select Transportation Mode Transportation Core Checklist
...
This reference keeps `select-transportation-mode` aligned with the AL-11 transportation and freight core and the `transportation-coordinator` skillset.
