...
The warehouse-supervisor skillset coordinates AL-14 labor and operating planning for frontline warehouse supervisors managing daily shift execution. It covers workload forecasting, labor requirement calculation, staffing planning, workload balancing, labor productivity analysis, overtime analysis, shift handoff planning, and daily warehouse operating plans.
...
- `tests/scenarios/warehouse-supervisor-daily-operating-plan.md`
