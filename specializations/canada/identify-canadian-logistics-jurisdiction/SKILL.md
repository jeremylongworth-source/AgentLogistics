---
name: identify-canadian-logistics-jurisdiction
description: Identify federal, provincial, territorial, modal, product, workplace, and activity jurisdiction for Canadian logistics research.
license: MIT
---
...
Use this specialization skill for Canada-specific logistics safety and compliance research. The expected output is a source-backed jurisdiction triage brief that separates jurisdiction, evidence, assumptions, regulatory interpretation, operational next steps, and qualified-review requirements.
...
- identify Canadian logistics jurisdiction, regulator ownership, province, territory, federal scope, workplace scope, mode scope, or activity scope
- separate federal, provincial, territorial, carrier, customs, dangerous-goods, workplace, facility, and employer program authority
- prepare a source plan before writing Canada-specific logistics safety or compliance claims
...
No fixed calculation required. Optional counts can compare facilities, provinces, territories, modes, products, documents, or activities when source records support them.
...
- jurisdiction, province or territory, mode, facility type, employer scope, product, activity, and source date are visible
- federal, provincial, territorial, carrier, customs, and employer-program authorities are separated
- the output does not collapse Canadian requirements into a single universal rule
