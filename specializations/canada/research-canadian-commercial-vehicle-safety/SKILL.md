---
name: research-canadian-commercial-vehicle-safety
description: Prepare Canadian commercial-vehicle safety research briefs for motor carrier, driver, vehicle, maintenance, and hours-of-service context.
license: MIT
---
...
Use this specialization skill for Canada-specific logistics safety and compliance research. The expected output is a source-backed Canadian commercial-vehicle safety research brief that separates jurisdiction, evidence, assumptions, regulatory interpretation, operational next steps, and qualified-review requirements.
...
- research Canadian commercial vehicle safety, motor carrier, truck, bus, driver hours, safety fitness certificate, inspections, maintenance, or National Safety Code context
- prepare a source-backed evidence request for a Canadian commercial vehicle operation
- separate federal extra-provincial carrier context from provincial and territorial commercial vehicle implementation
...
No fixed calculation required. Optional checks can summarize driver hours, trip counts, inspection records, maintenance intervals, carrier records, or out-of-service trends when evidence supports them.
...
- carrier type, operating scope, province or territory, lane, vehicle class, driver records, inspection records, and maintenance evidence are visible
- federal extra-provincial rules, provincial or territorial implementation, NSC references, carrier program, and driver records are separated
- driver qualification approval, vehicle roadworthiness certification, safety fitness approval, and enforcement advice are blocked
