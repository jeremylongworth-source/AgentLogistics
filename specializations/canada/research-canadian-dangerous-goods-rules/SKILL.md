---
name: research-canadian-dangerous-goods-rules
description: Prepare Transport Canada dangerous-goods research briefs for Canadian logistics without classifying or certifying dangerous goods.
license: MIT
---
...
Use this specialization skill for Canada-specific logistics safety and compliance research. The expected output is a source-backed Canadian dangerous-goods research brief that separates jurisdiction, evidence, assumptions, regulatory interpretation, operational next steps, and qualified-review requirements.
...
- research Canadian dangerous goods, TDG, dangerous goods documentation, classification evidence, proof of classification, safety marks, means of containment, or incident reporting
- prepare a dangerous-goods evidence checklist for Canadian transport
- separate consignor responsibility, classification evidence, packaging evidence, documentation, marks, emergency reporting, and qualified review
...
No fixed calculation required. Optional checks can compare quantities, means of containment, exception thresholds, or incident-report timing only when current official sources and user evidence support them.
...
- product hazard data, SDS, classification evidence, mode, quantity, packaging, marks, documents, and consignor role are visible
- classification evidence, documentation, containment, marks, training, and incident reporting are separated
- dangerous-goods classification, TDG compliance certification, shipping certification, and emergency-response approval are blocked
