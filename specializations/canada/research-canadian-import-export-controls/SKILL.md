---
name: research-canadian-import-export-controls
description: Prepare CBSA-centered Canadian import and export research briefs for logistics evidence, documentation, release, reporting, and broker review.
license: MIT
---
...
Use this specialization skill for Canada-specific logistics safety and compliance research. The expected output is a source-backed Canadian import/export research brief that separates jurisdiction, evidence, assumptions, regulatory interpretation, operational next steps, and qualified-review requirements.
...
- research Canadian import controls, export controls, CBSA commercial goods, release, declaration, CERS, customs records, border handoff, broker evidence, or restricted goods routing
- prepare an import/export evidence checklist for Canadian commercial logistics
- separate customs release, accounting, reporting, permits, broker, carrier, importer, exporter, and restricted-goods review boundaries
...
No fixed calculation required. Optional checks can summarize shipment count, value, quantities, tariff identifiers, declaration status, release status, or document gaps when evidence supports them.
...
- commercial goods, importer or exporter, broker, carrier, border crossing, documents, release status, and reporting status are visible
- CBSA guidance, other government department controls, broker evidence, carrier records, and user documents are separated
- customs brokerage advice, duty or tariff advice, permit approval, declaration approval, and release approval are blocked
