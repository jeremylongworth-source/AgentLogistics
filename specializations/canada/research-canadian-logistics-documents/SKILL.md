---
name: research-canadian-logistics-documents
description: Prepare Canadian logistics documentation research briefs for warehouse, transport, TDG, customs, import, export, carrier, and audit records.
license: MIT
---
...
Use this specialization skill for Canada-specific logistics safety and compliance research. The expected output is a source-backed Canadian logistics documentation research brief that separates jurisdiction, evidence, assumptions, regulatory interpretation, operational next steps, and qualified-review requirements.
...
- research Canadian logistics documents, shipping documents, waybills, BOLs, TDG documents, customs documents, import records, export records, carrier records, or audit trails
- prepare a document evidence checklist for a Canadian logistics movement or facility workflow
- separate operational documents, regulatory documents, commercial documents, system records, and approval boundaries
...
No fixed calculation required. Optional checks can summarize document completeness, record counts, mismatches, dates, quantities, identifiers, or retention gaps when evidence supports them.
...
- document type, owner, source system, shipment or facility context, date, identifier, and regulatory scope are visible
- BOL, waybill, TDG shipping document, customs release, export report, commercial invoice, WMS, TMS, and ERP records are separated
- document certification, customs filing approval, TDG certification, financial posting, and live record changes are blocked
