---
name: research-canadian-material-handling-safety
description: Prepare Canadian material-handling safety research briefs for warehouse movement, storage, lifting, traffic, and ergonomic risks.
license: MIT
---
...
Use this specialization skill for Canada-specific logistics safety and compliance research. The expected output is a source-backed Canadian material-handling safety research brief that separates jurisdiction, evidence, assumptions, regulatory interpretation, operational next steps, and qualified-review requirements.
...
- research Canadian material handling safety, manual handling, pallet movement, dock movement, warehouse traffic, lifting, ergonomic risk, or handling controls
- map material-handling hazards and evidence needed for a Canadian logistics facility
- separate observed handling risks from approved safety procedures, engineered controls, training, and supervision
...
No fixed calculation required. Optional checks can compare load weights, travel distances, frequency, exposure time, incident counts, or control completion when evidence supports them.
...
- load, task, frequency, equipment, pedestrian interaction, storage method, and worker exposure are visible
- manual handling, mechanical handling, traffic, ergonomics, PPE, training, and supervision are separated
- equipment certification, operator certification, and engineered control approval are blocked
