---
name: research-canadian-storage-requirements
description: Prepare Canadian storage requirement research briefs for warehouses, yards, regulated goods, hazardous products, inventory status, and facility controls.
license: MIT
---
...
Use this specialization skill for Canada-specific logistics safety and compliance research. The expected output is a source-backed Canadian storage requirement research brief that separates jurisdiction, evidence, assumptions, regulatory interpretation, operational next steps, and qualified-review requirements.
...
- research Canadian storage requirements, warehouse storage compliance, hazardous product storage, yard storage, rack storage, inventory holds, segregation, or facility control evidence
- prepare a source-backed storage requirement checklist for a Canadian logistics site
- separate product attributes, hazard data, facility controls, OHS authority, fire/building/environmental review, and employer procedure scope
...
- OHS, WHMIS, TDG, fire, building, environmental, insurer, landlord, and employer-program authorities are separated
- storage compliance approval, fire-code approval, structural approval, environmental approval, and inventory release are blocked
