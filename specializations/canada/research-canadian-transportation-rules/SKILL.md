---
name: research-canadian-transportation-rules
description: Prepare Canadian transportation rule research briefs for logistics movements while separating mode, province, territory, federal, carrier, and shipper scope.
license: MIT
---
...
Use this specialization skill for Canada-specific logistics safety and compliance research. The expected output is a source-backed Canadian transportation rule research brief that separates jurisdiction, evidence, assumptions, regulatory interpretation, operational next steps, and qualified-review requirements.
...
- research Canadian transportation rules, domestic freight, interprovincial movement, intraprovincial movement, mode requirements, carrier rules, or shipper obligations
- prepare a source-backed transportation compliance question list for a Canadian shipment or lane
- separate route, mode, carrier, shipper, consignee, border, dangerous-goods, and commercial-vehicle authority
...
- federal, provincial, territorial, modal, carrier, and contract rules are separated
