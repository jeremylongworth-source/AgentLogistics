---
name: research-canadian-workplace-safety
description: Prepare source-backed Canadian workplace safety research briefs for logistics operations without issuing compliance determinations.
license: MIT
---
...
Use this specialization skill for Canada-specific logistics safety and compliance research. The expected output is a source-backed Canadian workplace safety research brief that separates jurisdiction, evidence, assumptions, regulatory interpretation, operational next steps, and qualified-review requirements.
...
- research Canadian workplace safety, OHS, Canada Labour Code Part II, provincial OHS, warehouse hazards, inspections, incidents, or right-to-refuse context
- build a workplace safety evidence checklist for a Canadian warehouse, dock, yard, terminal, or logistics facility
- separate hazards, controls, employer program requirements, worker participation, and qualified-review boundaries
...
- federal versus provincial or territorial workplace authority is explicit
- hazards, controls, inspections, investigations, training, supervision, and committee or representative needs are separated
