---
name: classify-food-cold-chain-requirements
description: Classify food and cold-chain logistics requirements by product, temperature sensitivity, lot or expiry controls, sanitation needs, transport context, and jurisdiction.
license: MIT
---
...
Use this specialization skill to classify food and cold-chain logistics requirements before routing to temperature, sanitation, traceability, recall, storage, transportation, or handoff work.
...
- classify a food, beverage, ingredient, meal, animal food, refrigerated, frozen, or temperature-sensitive logistics request
- identify whether cold-chain, FEFO, expiry, lot traceability, sanitation, segregation, recall, or transport controls may be relevant
- prepare an evidence checklist for a food or cold-chain logistics workflow

## Non-Triggers

Do not use this skill when the user primarily needs to:

- approve a food safety plan, HACCP plan, preventive control plan, or regulatory compliance decision
- replace a qualified food safety, quality, legal, carrier, regulator, or customer review
- apply food or temperature assumptions without product, jurisdiction, and source context
...
1. Confirm product identity, intended use, packaging, lot or expiry attributes, temperature sensitivity, jurisdiction, mode, facility, and requested decision.
2. Classify the logistics controls that may apply: temperature, monitoring, excursion, FEFO, expiry, lot traceability, sanitation, segregation, recall, transportation, or handoff.
3. Separate universal logistics tasks from food-specific or cold-chain-specific evidence requirements.
4. Return a routing brief with missing evidence, source requirements, blocked approvals, and qualified-review handoffs.
