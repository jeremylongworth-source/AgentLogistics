---
name: manage-expiry-controlled-food-inventory
description: Manage expiry-controlled food inventory evidence, aging risk, hold states, disposition handoffs, and shelf-life review boundaries.
license: MIT
---
...
Use this specialization skill for food inventory with expiration, best-before, use-by, production date, or shelf-life controls.
...
- review expiry-controlled food inventory, aging risk, short-dated stock, or shelf-life status
- prepare hold, disposition, donation, customer exception, or recall evidence handoffs
- separate expiry planning from release or disposal approval

## Non-Triggers

Do not use this skill when the user primarily needs to:

- approve use of expired or short-dated food
- approve donation, destruction, relabeling, rework, or shelf-life extension
- declare food safe, legal, saleable, or compliant
...
1. Confirm product, lot, date code, expiry basis, shelf-life policy, inventory status, location, customer rules, and source system.
2. Classify stock by expiry risk, hold state, order exposure, traceability needs, and owner handoff.
3. Identify source conflicts and decisions requiring quality, food safety, customer, finance, or legal review.
4. Return an expiry-control plan with inventory groups, recommended evidence requests, and blocked disposition actions.
