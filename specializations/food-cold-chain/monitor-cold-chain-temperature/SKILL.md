---
name: monitor-cold-chain-temperature
description: Plan cold-chain temperature monitoring evidence reviews for food storage and transport without approving product release or equipment sufficiency.
license: MIT
---
...
Use this specialization skill to structure temperature monitoring evidence for food storage, staging, loading, transportation, and receiving.
...
- review temperature logger, probe, trailer, cooler, freezer, dock, or route temperature records
- identify monitoring gaps for a cold-chain food flow
- prepare a temperature evidence packet for quality or food safety review

## Non-Triggers

Do not use this skill when the user primarily needs to:

- approve product release after a temperature deviation
- certify sensors, calibration, refrigeration equipment, trailers, or containers
- replace a food safety, quality, customer, carrier, or regulator decision
...
1. Confirm product, target range source, monitoring device, calibration evidence if supplied, timestamps, timezone, location, route, and custody points.
2. Build a monitoring chronology across receiving, storage, staging, loading, transit, and delivery where records exist.
3. Flag missing records, time gaps, unit conflicts, device issues, source conflicts, and unexplained readings.
4. Return a monitoring evidence summary with review questions and blocked release or disposal decisions.
