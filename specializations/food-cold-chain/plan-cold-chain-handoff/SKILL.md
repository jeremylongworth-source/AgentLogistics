---
name: plan-cold-chain-handoff
description: Plan cold-chain food handoffs across receiving, storage, staging, loading, carrier, delivery, and exception review points.
license: MIT
---
...
Use this specialization skill for handoff planning between people, facilities, systems, and carriers in a food cold-chain workflow.
...
- plan cold-chain handoffs between receiving, storage, staging, loading, carrier pickup, delivery, returns, or exception review
- define source records and owner actions for custody, temperature, lot, expiry, status, and seal handoffs
- prepare a reviewer-ready handoff checklist for food cold-chain operations

## Non-Triggers

Do not use this skill when the user primarily needs to:

- approve custody, temperature excursion, product release, disposal, or customer acceptance decisions
- replace SOP, quality, food safety, carrier, customer, legal, or regulator review
- make live WMS, TMS, ERP, OMS, sensor, carrier, customer, or inventory changes
...
1. Confirm handoff point, product, lot, expiry, custody owner, system status, temperature basis, sensor or seal evidence, and next process owner.
2. Define what must be checked, recorded, reconciled, transferred, held, escalated, or reviewed at each handoff.
3. Flag missing records, conflicting statuses, custody gaps, temperature gaps, and authority gaps.
4. Return a handoff plan with owner actions, evidence gaps, blocked decisions, and qualified-review requirements.
