---
name: plan-cold-chain-transportation
description: Plan cold-chain food transportation evidence, equipment questions, temperature monitoring handoffs, sanitation needs, and carrier boundaries.
license: MIT
---
...
Use this specialization skill for refrigerated, frozen, chilled, heated, insulated, or temperature-sensitive food transportation planning.
...
- plan a cold-chain food shipment, carrier handoff, trailer requirement, route risk, or delivery temperature evidence packet
- review shipper, loader, carrier, receiver, vehicle, equipment, cleaning, monitoring, or record needs
- separate cold-chain transport planning from legal, food safety, or carrier approval

## Non-Triggers

Do not use this skill when the user primarily needs to:

- tender a shipment, approve a carrier, certify equipment, or determine sanitary transportation compliance
- declare food safe after transit or temperature deviation
- replace carrier contract, customer, food safety, legal, or regulator review
...
1. Confirm product, temperature basis, mode, route, carrier, shipper, loader, receiver, equipment type, monitoring evidence, and jurisdiction.
2. Map shipper, loader, carrier, and receiver handoffs with sanitation, temperature, loading, documentation, and record questions.
3. Identify missing temperature, cleaning, equipment, prior-load, custody, and delivery evidence.
4. Return a cold-chain transport plan with source-backed handoffs, blocked approvals, and qualified-review requirements.
