---
name: plan-food-segregation
description: Plan food logistics segregation for allergen, temperature, raw or ready-to-eat, hold, recalled, damaged, or nonconforming goods.
license: MIT
---
...
Use this specialization skill to plan logistics segregation for food products with incompatible status, temperature, allergen, raw or ready-to-eat, quality, recall, or contamination controls.
...
- plan food segregation in storage, staging, picking, loading, transportation, returns, or cross-dock workflows
- separate raw and ready-to-eat, allergen, temperature, hold, recall, damaged, or nonconforming inventory
- prepare a segregation evidence checklist for qualified review

## Non-Triggers

Do not use this skill when the user primarily needs to:

- approve allergen controls, food safety controls, rack layout, fire code, or sanitation sufficiency
- release held or recalled product
- replace local SOP, quality, food safety, customer, carrier, or regulator review
...
1. Confirm product groups, allergen or incompatibility attributes, temperature class, status, location, order exposure, and handling path.
2. Map where incompatible goods may touch shared space, labor, equipment, vehicles, packaging, or system statuses.
3. Identify segregation actions that are planning support versus approvals requiring qualified review.
4. Return a segregation plan with source gaps, owner handoffs, and blocked decisions.
