---
name: plan-sanitation-sensitive-logistics
description: Plan sanitation-sensitive food logistics workflows for facilities, equipment, vehicles, packaging, handling, and evidence handoffs.
license: MIT
---
...
Use this specialization skill for logistics workflows where cleaning, sanitation, allergen control, prior load, packaging, or contamination prevention may affect food handling.
...
- plan sanitation-sensitive receiving, storage, handling, loading, transportation, or returned-food workflows
- review cleaning, prior-load, vehicle, equipment, packaging, or facility evidence gaps
- prepare sanitation questions for a qualified food safety or quality reviewer

## Non-Triggers

Do not use this skill when the user primarily needs to:

- approve sanitation procedures, cleaning validation, allergen controls, or food safety plans
- certify vehicles, rooms, equipment, packaging, or employees
- override site sanitation, customer, carrier, or regulator requirements
...
1. Confirm product, allergen or contamination sensitivity, facility area, equipment, vehicle, packaging, prior load, cleaning records, and jurisdiction.
2. Map sanitation-sensitive touchpoints and identify controls that need user-provided SOP or official source support.
3. Flag source gaps, incompatible product or prior-load risks, and review owners.
4. Return a sanitation-sensitive logistics plan with evidence needs, blocked approvals, and qualified-review handoffs.
