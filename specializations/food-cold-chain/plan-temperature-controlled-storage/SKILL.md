---
name: plan-temperature-controlled-storage
description: Plan source-backed temperature-controlled food storage workflows, capacity questions, monitoring handoffs, hold states, and qualified-review boundaries.
license: MIT
---
...
Use this specialization skill for cold, frozen, chilled, heated, or otherwise temperature-controlled food storage planning.
...
- plan refrigerated, frozen, chilled, heated, or temperature-controlled food storage
- prepare storage-zone, capacity, hold, monitoring, or handoff questions for temperature-sensitive food
- separate storage planning from food safety approval

## Non-Triggers

Do not use this skill when the user primarily needs to:

- certify a room, refrigeration system, freezer, rack, equipment, or process
- declare product safe after an excursion or unsupported temperature history
- set legal temperature limits without current official or user-provided authority
...
1. Confirm product, required temperature basis, facility zone, storage duration, packaging, quantity, lot or expiry controls, monitoring evidence, and jurisdiction.
2. Map storage zones, capacity constraints, temperature-control evidence, hold states, and owner handoffs.
3. Identify conflicts between product specification, customer requirement, SOP, system data, and official source needs.
4. Return a storage plan with evidence gaps, monitoring handoffs, blocked approvals, and qualified-review requirements.
