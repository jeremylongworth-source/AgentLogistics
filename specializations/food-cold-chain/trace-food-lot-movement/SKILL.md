---
name: trace-food-lot-movement
description: Trace food lot movement across receiving, storage, transformation, shipping, returns, and customer handoffs using source-backed records.
license: MIT
---
...
Use this specialization skill to trace food lots, batches, date codes, or unique identifiers through logistics movements.
...
- trace a food lot, batch, date code, or unique identifier through receiving, storage, shipping, returns, or customer distribution
- prepare a traceability evidence packet for recall, hold, investigation, or customer review
- map critical movement records without making a compliance determination

## Non-Triggers

Do not use this skill when the user primarily needs to:

- declare traceability compliant under any law or customer program
- approve recall scope, public notices, customer notices, or regulator submissions
- invent missing lot movement records or reconcile quantities without source evidence
...
1. Confirm product, lot or code, date range, facilities, systems, trading partners, transaction types, and requested trace direction.
2. Build a source-by-source movement chain across receiving, storage, internal movement, transformation if supplied, shipping, returns, and customer handoffs.
3. Reconcile quantities by state and identify missing, conflicting, duplicated, or late records.
4. Return a trace packet with source gaps, affected parties, owner handoffs, and qualified-review boundaries.
