---
name: triage-temperature-excursion
description: Triage food cold-chain temperature excursions by evidence, affected lots, custody points, hold status, escalation needs, and blocked release decisions.
license: MIT
---
...
Use this specialization skill when temperature records suggest a food cold-chain deviation or excursion that needs evidence triage.
...
- triage a refrigerated, frozen, chilled, hot-hold, trailer, cooler, freezer, or dock temperature excursion
- identify affected lots, timestamps, custody points, and hold requirements for review
- prepare an escalation packet for quality, food safety, customer, carrier, or regulator review

## Non-Triggers

Do not use this skill when the user primarily needs to:

- decide that exposed food is safe, legal, saleable, releasable, or disposable
- calculate regulatory compliance without current official and local source context
- override customer, quality, carrier, or regulator hold instructions
...
1. Confirm product, lot, expiry, temperature range source, actual readings, duration, location, equipment, custody, and current hold status.
2. Create an excursion chronology and identify affected inventory, orders, shipments, customers, and source conflicts.
3. Separate observed data, inferred risk, missing evidence, and decisions requiring qualified review.
4. Return an escalation packet with reviewer questions, blocked actions, and next evidence requests.
