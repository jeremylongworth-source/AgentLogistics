---
name: research-us-commercial-vehicle-safety
description: Prepare United States commercial-vehicle safety research briefs for motor carrier, driver, vehicle, maintenance, and hours-of-service context.
license: MIT
---
...
- research US commercial vehicle safety, FMCSA, motor carrier, CMV, driver hours, HOS, registration, inspections, maintenance, CDL, or safety fitness context
- prepare a source-backed evidence request for a US commercial vehicle operation
- separate interstate carrier context from intrastate and state implementation questions
...
- carrier type, operating scope, state or territory, lane, vehicle class, driver records, inspection records, and maintenance evidence are visible
- FMCSA rules, state implementation, carrier program, driver records, vehicle records, and maintenance records are separated
- driver qualification approval, vehicle roadworthiness certification, operating authority approval, and enforcement advice are blocked
