---
name: research-us-hazardous-materials-rules
description: Prepare PHMSA and DOT hazardous-materials research briefs for United States logistics without classifying or certifying hazmat.
license: MIT
---
...
Use this specialization skill for United States logistics safety and compliance research. The expected output is a source-backed US hazardous-materials research brief that separates jurisdiction, evidence, assumptions, regulatory interpretation, operational next steps, and qualified-review requirements.
...
- research US hazardous materials, hazmat, HMR, PHMSA, DOT shipping papers, classification evidence, packaging, labels, placards, training, or incident reporting
- prepare a hazardous-materials evidence checklist for US transport
- separate offeror or shipper responsibility, classification evidence, packaging evidence, documentation, marks, labels, placards, emergency response, and qualified review
...
No fixed calculation required. Optional checks can compare quantities, packaging, placarding, exception thresholds, or incident-report timing only when current official sources and user evidence support them.
...
- product hazard data, SDS, classification evidence, mode, quantity, packaging, marks, labels, placards, documents, and offeror role are visible
- classification evidence, shipping papers, packaging, marks, labels, placards, training, and incident reporting are separated
- hazmat classification, HMR compliance certification, shipping certification, and emergency-response approval are blocked
