---
name: research-us-import-export-controls
description: Prepare CBP-centered United States import and export research briefs for logistics evidence, documentation, release, reporting, and broker review.
license: MIT
---
...
Use this specialization skill for United States logistics safety and compliance research. The expected output is a source-backed US import/export research brief that separates jurisdiction, evidence, assumptions, regulatory interpretation, operational next steps, and qualified-review requirements.
...
- research US import controls, export controls, CBP commercial goods, customs entry, release, declaration, AES, EEI, broker evidence, or restricted goods routing
- prepare an import/export evidence checklist for US commercial logistics
- separate customs entry, release, reporting, permits, broker, carrier, importer, exporter, and restricted-goods review boundaries
...
No fixed calculation required. Optional checks can summarize shipment count, value, quantities, HTS or Schedule B identifiers, declaration status, release status, or document gaps when evidence supports them.
...
- commercial goods, importer or exporter, broker, carrier, port of entry or export, documents, release status, and reporting status are visible
- CBP guidance, partner government agency controls, broker evidence, carrier records, and user documents are separated
- customs brokerage advice, duty or tariff advice, permit approval, entry approval, declaration approval, and release approval are blocked
