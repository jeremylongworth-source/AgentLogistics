---
name: research-us-loading-security
description: Prepare United States loading, cargo securement, seal, yard, dock, and shipment security research briefs for logistics operations.
license: MIT
---
...
Use this specialization skill for United States logistics safety and compliance research. The expected output is a source-backed US loading and security research brief that separates jurisdiction, evidence, assumptions, regulatory interpretation, operational next steps, and qualified-review requirements.
...
- research US loading security, cargo securement, load securement, seals, dock security, yard security, trailer loading, container loading, or theft prevention controls
- prepare source-backed loading and security evidence requests for US freight movement
- separate cargo condition, load plan, securement evidence, chain of custody, seal control, FMCSA scope, and qualified review
