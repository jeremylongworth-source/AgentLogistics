---
name: research-us-logistics-documents
description: Prepare United States logistics documentation research briefs for warehouse, transportation, hazmat, customs, import, export, carrier, and audit records.
license: MIT
---
...
Use this specialization skill for United States logistics safety and compliance research. The expected output is a source-backed US logistics documentation research brief that separates jurisdiction, evidence, assumptions, regulatory interpretation, operational next steps, and qualified-review requirements.
...
- research US logistics documents, shipping papers, BOLs, hazmat documents, customs documents, import records, export records, AES records, carrier records, or audit trails
- prepare a document evidence checklist for a US logistics movement or facility workflow
...
- BOL, shipping paper, hazmat document, customs entry, export filing, commercial invoice, WMS, TMS, ERP, OMS, and carrier records are separated
- document certification, customs filing approval, hazmat certification, financial posting, and live record changes are blocked
