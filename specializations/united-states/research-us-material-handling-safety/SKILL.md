---
name: research-us-material-handling-safety
description: Prepare United States material-handling safety research briefs for warehouse movement, storage, lifting, traffic, and ergonomic risks.
license: MIT
---
...
Use this specialization skill for United States logistics safety and compliance research. The expected output is a source-backed US material-handling safety research brief that separates jurisdiction, evidence, assumptions, regulatory interpretation, operational next steps, and qualified-review requirements.
...
- research US material handling safety, manual handling, pallet movement, dock movement, warehouse traffic, lifting, ergonomic risk, or handling controls
- map material-handling hazards and evidence needed for a US logistics facility
- separate observed handling risks from approved safety procedures, engineered controls, OSHA guidance, training, and supervision
