---
name: research-us-powered-equipment-safety
description: Prepare United States powered industrial truck and powered equipment safety research briefs for logistics operations.
license: MIT
---
...
Use this specialization skill for United States logistics safety and compliance research. The expected output is a source-backed US powered-equipment safety research brief that separates jurisdiction, evidence, assumptions, regulatory interpretation, operational next steps, and qualified-review requirements.
...
- research US powered equipment safety, powered industrial trucks, forklifts, lift trucks, conveyors, AGVs, AMRs, ASRS, battery charging, guarding, or operator training evidence
- prepare a qualified-review packet for powered equipment use in a US logistics site
- separate OSHA standards, manufacturer instructions, employer safety program, training evidence, inspection evidence, and maintenance evidence
...
- OSHA standards, manufacturer instructions, employer program, site controls, and maintenance evidence are separated
