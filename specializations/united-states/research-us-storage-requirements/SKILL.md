---
name: research-us-storage-requirements
description: Prepare United States storage requirement research briefs for warehouses, yards, hazardous materials, hazardous waste, inventory status, and facility controls.
license: MIT
---
...
Use this specialization skill for United States logistics safety and compliance research. The expected output is a source-backed US storage requirement research brief that separates jurisdiction, evidence, assumptions, regulatory interpretation, operational next steps, and qualified-review requirements.
...
- research US storage requirements, warehouse storage compliance, hazardous chemical storage, hazardous materials storage, hazardous waste storage, yard storage, rack storage, inventory holds, segregation, or facility controls
- prepare a source-backed storage requirement checklist for a US logistics site
- separate product attributes, hazard data, facility controls, OSHA authority, EPA questions, fire/building/environmental review, and employer procedure scope
...
No fixed calculation required. Optional checks can compare storage quantities, location counts, segregation groups, hold status, capacity, inspection age, or exposure counts when evidence supports them.
...
- product, quantity, location, hazard data, lot or expiry controls, storage method, facility context, and jurisdiction are visible
- OSHA, HazCom, HMR, EPA, fire, building, environmental, insurer, landlord, and employer-program authorities are separated
- storage compliance approval, fire-code approval, structural approval, environmental approval, hazardous-waste determination, and inventory release are blocked
