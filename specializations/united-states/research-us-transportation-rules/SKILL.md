---
name: research-us-transportation-rules
description: Prepare United States transportation rule research briefs while separating mode, state, federal, carrier, shipper, and consignee scope.
license: MIT
---
...
Use this specialization skill for United States logistics safety and compliance research. The expected output is a source-backed US transportation rule research brief that separates jurisdiction, evidence, assumptions, regulatory interpretation, operational next steps, and qualified-review requirements.
...
- research US transportation rules, domestic freight, interstate movement, intrastate movement, mode requirements, carrier rules, or shipper obligations
- prepare a source-backed transportation compliance question list for a US shipment or lane
- separate route, mode, carrier, shipper, consignee, border, hazardous-materials, and commercial-vehicle authority
...
No fixed calculation required. Optional checks can summarize lane count, mode split, shipment counts, carrier coverage, or exception rates when evidence supports them.
...
- mode, lane, origin, destination, carrier role, shipper role, consignee role, and border status are visible
- federal, state, territorial, modal, carrier, and contract rules are separated
- legal compliance conclusions, booking approval, carrier contract approval, and customs determinations are blocked
