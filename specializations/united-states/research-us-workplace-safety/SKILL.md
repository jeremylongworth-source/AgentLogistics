---
name: research-us-workplace-safety
description: Prepare source-backed United States workplace safety research briefs for logistics operations without issuing compliance determinations.
license: MIT
---
...
Use this specialization skill for United States logistics safety and compliance research. The expected output is a source-backed US workplace safety research brief that separates jurisdiction, evidence, assumptions, regulatory interpretation, operational next steps, and qualified-review requirements.
...
- research US workplace safety, OSHA, state plan, warehousing safety, OSHA inspections, worker rights, employer responsibilities, or hazard controls
- build a workplace safety evidence checklist for a US warehouse, dock, yard, terminal, or logistics facility
- separate hazards, controls, OSHA standards, state-plan questions, employer program requirements, worker rights, and qualified-review boundaries
...
No fixed calculation required. Optional checks can summarize incident counts, inspection cadence, corrective-action aging, training coverage, or risk ratings when evidence supports them.
...
- federal OSHA versus OSHA-approved state-plan authority is explicit
- hazards, controls, inspections, investigations, training, supervision, and employer responsibilities are separated
- legal compliance conclusions, safety approval, and employer program signoff are blocked
